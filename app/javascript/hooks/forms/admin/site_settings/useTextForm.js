...
export default function useTextForm({ defaultValues: _defaultValues, ..._config } = {}) {
  const { t, i18n } = useTranslation();

  const fields = useMemo(() => ({
    value: {
      placeHolder: t('forms.admin.site_settings.fields.value.text_placeholder'),
      hookForm: {
        id: 'value',
      },
    },
  ...
  const validationSchema = useTextFormValidation();
