...
const ROOM_COPY = {
  ...
  tr: {
    ...
    overview: {
      ...
      body: 'Bu oda üzerinden oturum, dosya, erişim ve yönetim işlemlerini yönetin.',
      live: 'Canlı durum',
      attendees: 'Canlı katılımcı',
      upcoming: 'Planlı',
      completed: 'Tamamlanan',
      activity: 'Oturum aktivitesi',
      activityEmpty: 'Tamamlanmış oturum yok.',
      shortcuts: 'Hızlı erişim',
      shortcutsBody: 'En sık kullanılan oda akışları için kısayollar.',
      goSessions: 'Tüm oturumlar',
      goFuture: 'Gelecek oturum planla',
      goHistory: 'Geçmiş oturumlar',
      goSettings: 'Oda ayarları',
      stateLive: 'Canlı',
      stateIdle: 'Hazır',
    },
    sessions: {
      title: 'Tüm oda oturumları',
      body: 'Bu oda için geçmiş ve gelecek oturumlar tek tabloda.',
      ...
      status: 'Durum',
      action: 'İşlem',
      noData: 'Bu oda için oturum bulunamadı.',
      futureType: 'Gelecek',
      pastType: 'Geçmiş',
      open: 'Katıl',
    ...
    history: {
      title: 'Geçmiş oturumlar ve kayıtlar',
      body: 'Bu oda için tamamlanan oturumları, raporları ve kayıtları inceleyin.',
      tabs: {
        meetings: 'Geçmiş Oturumlar',
        recordings: 'Kayıtlar',
      },
      meetingsTitle: 'Geçmiş Oturumlar/Toplantılar',
      recordingsTitle: 'Oda Kayıtları',
      noMeetings: 'Tamamlanmış oturum yok.',
      noUsers: 'Bu toplantıda kullanıcı kanıtı yok.',
      noRecordings: 'Bu oda için kayıt yok.',
      date: 'Tarih',
      meeting: 'Toplantı',
      users: 'Kullanıcı',
      duration: 'Süre',
      ...
      late: 'Geç',
      missed: 'Kaçırıldı',
      loadError: 'Toplantı kanıtları yüklenemedi.',
      ...
      reportSubtitle: 'Bu tamamlanan oturum için etkileşim, dikkat, katılım ve kanıt özetini inceleyin.',
      attendanceScore: 'Katılım Skoru',
      attentionScore: 'Dikkat Skoru',
      engagementScore: 'Etkileşim Skoru',
      activityMetric: 'Aktivite Skoru',
      focusRate: 'Odak Oranı',
      checkPass: 'Kontrol Başarı',
      timelineTitle: 'Etkileşim Zaman Çizelgesi',
      timelineBody: 'Bu oturum için aktivite dağılımı ve son etkileşim olayları.',
      noTimeline: 'Etkileşim zaman çizelgesi yok.',
      time: 'Saat',
      type: 'Tür',
      detail: 'Detay',
      focusBlur: 'Odak / Ayrılma',
      score: 'Skor',
      status: 'Durum',
      statusStrong: 'Güçlü',
      statusWatch: 'İzle',
      statusRisk: 'Riskli',
      statusLeftEarly: 'Erken Ayrıldı',
      ...
      quizOkLabel: 'QUIZ OK',
      quizNokLabel: 'QUIZ Başarısız',
      quizLateLabel: 'QUIZ Geç',
      quizMissedLabel: 'QUIZ Kaçırıldı',
      pollAnswers: 'Anket',
      chatMessages: 'Mesaj',
      reactionsLabel: 'Tepkiler',
      raiseHands: 'El Kaldırma',
      whiteboardAnnotationsLabel: 'Beyaz Tahta Notları',
      sharedNotesLabel: 'Paylaşılan Notlar',
      attnLabel: 'ATTN',
      riskLabel: 'RISK',
      firstCheck: 'İlk Kontrol',
      lastCheck: 'Son Kontrol',
      idleActive: 'Pasif / Aktif',
      detailTitle: 'Katılımcı detayı',
      detailSubtitle: 'Bu oturum için ayrıntılı katılım, dikkat ve devam kanıtları.',
      noParticipantDetail: 'Katılımcı detayı seçilmedi.',
      detailAction: 'Detay',
      attributeName: 'Özellik',
      attributeValue: 'Skor / Değer',
      nativeTitle: 'Öğrenim Analitiği Paneli (yerel)',
      nativeBody: 'Daha derin BBB analitiği için yerel gösterge paneli kullanılabilir.',
      totalUsers: 'Toplam Kullanıcı',
      activityScore: 'Aktivite Skoru',
      timeline: 'Zaman Çizelgesi',
      polls: 'Anket',
      quizzes: 'Quiz',
      openNative: 'Yerel Analitiği Aç',
    },
    future: {
      title: 'Gelecek oturumlar ve planlama',
      body: 'Bu oda için yaklaşan oturumları yönetin.',
      ...
      roomIcs: 'Oda ICS',
      scheduleList: 'Yaklaşan oturumlar',
      noFuture: 'Planlı gelecek oturum yok.',
      startNow: 'Şimdi başlat',
      cancel: 'İptal',
      required: 'Başlık, başlangıç ve bitiş gerekli.',
      created: 'Oturum oluşturuldu.',
      startedNow: 'Oturum şimdi başlatıldı.',
      cancelled: 'Oturum iptal edildi.',
      error: 'Planlama isteği başarısız.',
    },
    files: {
      title: 'Oda dosyaları',
      body: 'Sunum kütüphanenizi, paylaşılan dosyaları inceleyin ve bu oda için varsayılan dosyayı seçin.',
      disabled: 'Bu oda için dosya yükleme aktif değil.',
    },
    access: {
      title: 'Katılımcılar',
      body: 'Bu oda için oda sahibini ve paylaşılan katılımcıları inceleyin.',
      disabled: 'Platform genelinde oda paylaşımı kapalı.',
    },
    settings: {
      title: 'Oda ayarları',
      body: 'Oda varsayımları, moderasyon, erişim kodları ve silme işlemleri.',
    },
  },
};
